namespace Offsets {
    uintptr_t UWorld = 0x1215C178; //fresh dump
    uintptr_t GObjects = 0x12133D70; //fresh dump
    uintptr_t GNames = 0x1233C1A0; //fresh dump
    ...
    uintptr_t TeamIndex = 0x1211; //fresh dump
    uintptr_t ProjectileSpeed = 0x1E40;
    uintptr_t ProjectileGravity = 0x1E44;
    uintptr_t PlayerName = 0xAA8; //fresh dump
    ...
    uintptr_t ProjectileSpeed = 0x1E40; //fresh dump
    uintptr_t ProjectileGravity = 0x1E44; //fresh dump
